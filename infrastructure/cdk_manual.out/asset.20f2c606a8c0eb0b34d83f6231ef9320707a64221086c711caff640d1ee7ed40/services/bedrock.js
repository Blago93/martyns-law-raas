...
const MODEL_CASCADE = [
    {
        id: "anthropic.claude-3-5-sonnet-20241022-v2:0", // Stable V2 - Most Reliable High-End Model
        label: "Claude 3.5 Sonnet v2",
        maxTokens: 1024,
    },
    {
        id: "anthropic.claude-3-7-sonnet-20250219-v1:0", // Try 3.7 as fallback/option
        label: "Claude 3.7 Sonnet",
        maxTokens: 1024,
    },
    {
        id: "anthropic.claude-3-5-haiku-20241022-v1:0", // Fast Haiku
